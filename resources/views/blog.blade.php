								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li><a href="{{route('blog_single')}}">Blog Post<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="{{route('regular')}}">Regular Post<i class="fas fa-chevron-down"></i></a></li>
											<li><a href="{{route('{{route('cart.index')}}')}}">Cart<i class="fas fa-chevron-down"></i></a></li>
				...
				<div class="col">
					<div class="blog_posts d-flex flex-row align-items-start justify-content-between">
						...
						<div class="blog_post">
							...
							<div class="blog_button"><a href="blog_single">Continue Reading</a></div>
						</div>
